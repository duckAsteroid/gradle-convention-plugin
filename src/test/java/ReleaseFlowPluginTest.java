...
/**
 * Confirms duckasteroid-release-flow registers all ten of its tasks (see the file-level comment
 * in duckasteroid-release-flow.gradle): the five original per-project tasks, plus the
 * tagReleaseCandidates/promoteReleaseCandidates/explainVersions aggregators and the
 * now-rootProject-scoped installReleaseWorkflows/checkReleaseWorkflows (see
